                    ...
                    <tbody>
                        <?php foreach ($commandeItems as $commandeItem): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="../src/Controller/DeleteHandler.php?entityClass=CommandeItem&id=<?php if(isset($commandeItem["id"])): echo $commandeItem["id"] ; endif; ?>" class="btn btn-outline-danger delete-row">
