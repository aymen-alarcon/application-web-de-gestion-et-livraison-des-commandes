            ...
            <div class="card card-dark mb-4 p-4">
              ...
              <div class="row g-3">
                <div class="col-md-6">
                  ...
                  <input class="form-control bg-black" name="address" placeholder="Enter drop-off location">
                </div>
                <div class="col-md-6">
                  <label class="form-label text-white">Contact Person</label>
                  <input class="form-control bg-black mb-2" name="titre" placeholder="Name">
                  <input class="form-control bg-black" name="phone" placeholder="Phone">
                </div>
              </div>
            </div>
            <div class="card card-dark mb-4 p-4">
              ...
              <!-- <div class="row g-3 mb-3 vehicle-option">
                <div class="col-6 col-sm-3 text-center">
                  <input type="radio" name="vehicle" id="bike" value="bike" checked>
                  <label for="bike" class="p-3 rounded w-100 d-block text-white">
                    <i class="fw-bold fs-4 bi bi-bicycle"></i>
                  </label>
                </div>
                <div class="col-6 col-sm-3 text-center">
                  <input type="radio" name="vehicle" id="scooter" value="scooter">
